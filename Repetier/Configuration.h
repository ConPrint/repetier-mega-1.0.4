...
#define Y_MAX_LENGTH 2000
#define Z_MAX_LENGTH 500
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define PARK_POSITION_X 100
#define PARK_POSITION_Y 100
...
#define UI_PRINTER_COMPANY "ConPrint"
...
#define MOTOR_DRIVER_1(var) StepperDriver<-1,-1,-1,0,0> var(80,10)
...
========== Start configuration string ==========
{
    ...
    "motorDrivers": [
        {
            "t": "Stepper",
            "s": "StepperDriver<-1,-1,-1,0,0> var(80,10)",
            "invertEnable": "0",
            "invertDirection": "0",
            "stepsPerMM": 80,
            "speed": 10,
